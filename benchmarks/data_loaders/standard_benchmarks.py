...
class StandardBenchmarkLoader:
        ...
        if url.startswith('hf://'):
            ...
            try:
                ...
                downloaded = hf_hub_download(
                    ...
                    repo_type='dataset', local_dir=str(self.data_dir / '_hf_cache')
                )
                import shutil
            ...
            try:
                ...
                raise RuntimeError(f"Could not download {dataset_name}. "
    ...
    def load_dataset(
        ...
        if config.get('synthetic', False):
            ...
            logger.info(f"Loaded {dataset_name}: {len(result)} samples, "
    ...
    def prepare_incremental_batches(
        ...
        """
        df = self.load_dataset(dataset_name, target_col=target_col,
