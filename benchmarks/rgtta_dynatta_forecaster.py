...
class _RegimeMemory:
    ...
    def _compute_similarity(
        ...
        return float(self.w_ks * ks_sim + self.w_wass * w_sim
...
class RGTTADynaTTAForecaster:
    ...
    def _compute_dynamic_lr(self, z: float, dr: float, dp: float) -> float:
        ...
        lam = 1 + (alpha_max / (alpha_min + self.eps) - 1) / (
    ...
    def update_with_new_data(self, new_df: pd.DataFrame) -> Dict[str, Any]:
        ...
        optimizer = optim.Adam(
            ...
            lr=dynamic_lr, weight_decay=1e-5, eps=1e-8
        )
        self.model.train()
    ...
    def get_tier_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_steps_per_batch": (
                self._total_steps_all_batches / max(1, self._batch_count)
            ),
