...
class TestDataUtilities:
    ...
    def test_data_preprocessor(self):
        ...
        # Test fit_transform
        df_transformed, metadata = preprocessor.fit_transform(
            df, target_col='y', exog_cols=['exog1']
        )
        ...
        df_test = df.tail(12)
        df_test_transformed = preprocessor.transform(
            df_test, target_col='y', exog_cols=['exog1']
        )
